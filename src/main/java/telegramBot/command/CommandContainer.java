...
public class CommandContainer {
    ...
    public CommandContainer(MessageService messageService, UserService userService, AdminService adminService) {
        ...
        this.commandContainer.put(CommandName.SUBSCRIPTIONS.getName(), new SubscriptionCommand(messageService, userService));
