...
CREATE TABLE IF NOT EXISTS Bot_status(id int GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
                        status character varying(7));

INSERT INTO Bot_status (status) VALUES ('create');
...
INSERT INTO Subscription (lang) VALUES ('JavaScript');
INSERT INTO Subscription (lang) VALUES ('Python');
INSERT INTO Subscription (lang) VALUES ('Java');
INSERT INTO Subscription (lang) VALUES ('PHP');
INSERT INTO Subscription (lang) VALUES ('C#');
...
CREATE TABLE IF NOT EXISTS Users(id int GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
                   chat_id character varying(30), active boolean);
